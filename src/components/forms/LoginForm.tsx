  ...
  return (
   <div className="w-full">
    ...
    >
      ...
      />
      <PasswordInput label="Password" error={errors.password ? errors.password : ''} touched={touched.password} name="password" onChange={handleChange} value={values.password} onBlur={handleBlur} 
      />
      <button
        type="submit"
