    ...
    <div className="w-full">
      ...
      >
        ...
        <div className="w-[400px]">
          <span className="text-[#3F3F3F] w-[400px] mt-1 text-right text-[13px] cursor-pointer px-1">
            6-digit code
          </span>
        ...
        <label className="text-[#A1A1A1] w-[400px] text-right text-[13px] cursor-pointer px-1">
          Didn&lsquo;t receive code?{' '}
          <span className="font-bold text-[#32C87D]">Resend</span>
        </label>
