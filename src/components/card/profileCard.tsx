...
const ProfileCard = ({
  ...
  return (
    <div
      ref={reference}
      className="w-[309px] h-[287px] right-3 top-[85px] p-[16px] absolute rounded-[8px] shadow-md bg-white flex flex-col items-center justify-center"
    >
      ...
      <h3 className="capitalize text-[#3F3F3F] font-montserrat  font-semibold text-center text-[18px] my-4">
        Oloson Kate
      </h3>
      <div
        className="w-full p-4 flex items-center cursor-pointer border-b border-[#E3E3E3] mt-10"
        onClick={onLogOut}
      >
        <Logout />
