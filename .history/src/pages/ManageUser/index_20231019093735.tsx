        ...
        <div className="flex w-full items-center justify-between">
          <div className="bg-white rounded-md text-sm p-1 h-[45px]">
            ...
            <div className="w-[600px] h-[48px] flex items-center  ">
              <input type="text" name="search" className="h-[48px] focus:outline-none rounded-[8px] rounded-r-none w-[92%] px-[16px]" placeholder="Search" />
              <div className="border bg-white border-[#EAEAEA]  rounded-[8px]  rounded-l-none -ml-4  flex items-center justify-center w-[8%] h-[48px]">
                <Search />
              </div>
            </div>
