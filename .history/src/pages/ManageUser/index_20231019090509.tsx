        ...
        <div className="flex w-full items-center justify-between">
          <div className="bg-white rounded-md text-sm p-1 h-[45px]">
            ...
            <div className="w-[664px] h-[48px]">
              <input type="text" name="search" className="h-[48px] rounded-[8px] w-[90%] border border-[#EAEAEA] px-[16px]" placeholder="Search" />
              <div className="border border-[#EAEAEA] rouneded-[8px] flex items-center justify-center w-[10px] h-[48px]">
