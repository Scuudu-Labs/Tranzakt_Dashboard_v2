...
const OneNotify = () => {
    return (
        <div className='w-full py-[18px] px-[16px] bg-red-400 flex items-center border-b-[0.2px] border-[#A1A1A1]'>
            <div className='w-[44px] h-[44px] rounded-[44px] bg-[#EBF9F2] text-center flex items-center justify-center mr-4'>
                <GroupImage />
            </div>
            <div className='flex flex-col'>
                <h2 className='font-montserrat font-[500] text-[16px] tracking-[0.3px] mb-2 text-[#3F3F3F]'>20 users completed their KYC</h2>
