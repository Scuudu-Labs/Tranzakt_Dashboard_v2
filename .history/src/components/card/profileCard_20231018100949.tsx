...
const ProfileCard = ({reference}: {reference:DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement> }) => {
  return (
    <div ref={reference} className='w-[309px] h-[287px] right-0 top-[85px] p-[16px] absolute rounded-[8px] bg-white flex flex-col items-center justify-center'>
