...
const ProfileCard = () => {
  return (
    <div className='w-[309px] h-[287px] p-[16px] absolute rounded-[8px] bg-white flex flex-col items-center justify-center'>
        <div className='w-[71px] h-[71px] rounded-[71px] bg-[#EBF9F2] flex items-center justify-center'>
            ...
            <span className='capitalize text-[#3F3F3F] font-montserrat font-semibold text-center text-[18px] my-4'>Oloson Kate</span>
        </div>
