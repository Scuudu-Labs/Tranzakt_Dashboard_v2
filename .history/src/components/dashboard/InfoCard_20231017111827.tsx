...
export default function AmountInfoCard(props: {
  ...
  return (
    <div className="w-[260px] h-[130px] flex flex-col rounded-[16px] bg-white border-[1px] p-[16px] border-[#EAEAEA]">
      <p className="text-[#A1A1A1] font-montserrat text-[14px] tracking-[0.3px] font-[500]">{props.label}</p>
