...
const TransactionCard = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col rounded-[16px] bg-white border-[1px] py-[16px] border-[#E3E3E3]">
        ...
        >Transactions</h2>
        <div className='px-[16px] flex items-center gap-x-2 py-[12px]'>
      ...
      <h2 className="font-montserrat font-semibold tex-[24px] tracking-[0.5px] py-2 ">₦34,000.00</h2>
        </div>
      ...
      <h2 className="font-montserrat font-semibold tex-[24px] tracking-[0.5px] ">₦20,964.00</h2>
        </div>
  </div>
  )
}
