...
export default function AmountInfoCard(props: {
  ...
  return (
    <div className="h-[107px] flex flex-col rounded-[16px] bg-white border-[1px] p-[16px] border-[#EAEAEA]">
      ...
      <span className="text-[#A1A1A1] text-[12px] font-[400] tracking-[0.3px] ml-2">than last week</span>
      </div>
    </div>
  );
}
