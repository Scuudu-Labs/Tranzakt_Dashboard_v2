      ...
      <div className="flex flex-col gap-y-3">
        <NavLink
          ...
          className={({isActive, isPending}) => (
            isActive ? "bg-[#32C87D] flex items-center gap-x-2 py-3 px-5 rounded-[16px]" : isPending ? 
            "flex items-center gap-x-2 hover:bg-[#E9F7F0] hover:border-r-[8px] py-3 px-5 hover:border-[#32C87D] hover:text-[#32c87d]"
            : ""
