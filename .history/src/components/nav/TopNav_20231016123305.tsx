    ...
    <div className="sticky top-0 h-[80px] border-b-[0.5px] border-[#BABABA] w-full flex  items-center z-10">
      ...
      <div className="flex justify-between px-6 w-full items-center">
        <div className="w-[648px] relative px-6">
          <div className="absolute left-10 w-[14px] h-[14px] top-2">
          <Search />
          </div>
          <input type="text" className="w-full text-[16px] font-montserrat bg-[#F5F7F9] focus:outline-none rounded-[8px] px-[16px] py-[8px]" placeholder="Query" />
        </div>
