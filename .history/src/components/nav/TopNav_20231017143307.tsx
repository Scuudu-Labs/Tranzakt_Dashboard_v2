  ...
  return (
    <div className="sticky z-20 top-0 bg-white h-[80px] border-b-[0.5px] border-[#E3E3E3] w-full flex  items-center ">
      ...
      <div className="flex items-center justify-center gap-x-5 px-5">
        ...
        <div className="h-[40px] cursor-pointer w-[40px] rounded-full bg-[#32C87D] flex items-center justify-center text-sm text-white" onClick={() => setOpenProfile(!openProfile)}>
          OK
        </div>
