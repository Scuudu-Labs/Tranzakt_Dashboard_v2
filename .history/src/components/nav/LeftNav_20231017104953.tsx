      ...
      <div className="flex flex-col px-4 py-4 gap-y-3">
        <NavLink
          ...
          className={({isActive, isPending}) => (
            isActive ? "bg-[#32C87D] flex items-center gap-x-2 py-3 px-5 rounded-[16px] mb-3 text-white" : isPending ? 
            "flex items-center w-full gap-x-2 hover:bg-[#E9F7F0] text-[#A1A1A1]   py-3 px-5 hover:text-[#32c87d]"
            : "flex items-center w-full gap-x-2 hover:bg-[#E9F7F0] text-[#A1A1A1] hover:rounded-[16px] mb-3 py-3 px-5 hover:text-[#32c87d]"
           )}
        >
