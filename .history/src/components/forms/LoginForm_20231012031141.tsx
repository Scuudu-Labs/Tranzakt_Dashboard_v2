    ...
    >
      ...
      <div className="flex w-[400px] mx-auto flex-col mb-6 gap-y-2">
        ...
        <input
          ...
          className="w-full rounded-md py-2 border outline-none border-[#A1A1A1] w-full placeholder-[#A1A1A1] px-2"
      ...
      <div className="flex w-[400px] mx-auto mb-6 flex-col gap-y-2">
        ...
        <input
          ...
          className="w-full rounded-md py-2 border w-full outline-none border-[#A1A1A1] placeholder-[#A1A1A1] px-2"
      ...
      <button
        type="submit"
        className="text-white bg-[#32C87D] w-[400px] mx-auto py-3 mb-2 mt-5 rounded-md"
      >
        Login
      </button>
    </form>
