...
export default function LoginForm() {
  ...
  return (
   <div className="w-full">
    ...
    >
      <div className="flex w-[372px] mx-auto flex-col mb-4 gap-y-2">
      ...
      <div className="flex w-[372px] mx-auto flex-col mb-6 gap-y-2">
        <label>Email</label>
        <input
      ...
      <div className="flex w-[372px] mx-auto mb-6 flex-col gap-y-2">
